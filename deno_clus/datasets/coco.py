...
def make_coco_transforms(image_set, fix_size=True, strong_aug=False, args=None):
    ...
    if image_set == 'stand':
        return T.Compose([
            T.RandomResize([100], max_size=101),
            normalize,
        ])
...
def build(image_set, args):
    ...
    PATHS = {
        ...
        "stand": (root / "stand2017", root / "annotations" / f'{mode}_stand2017.json'),
    }
