...
from engine0 import evaluate, train_one_epoch, test
...
def get_args_parser():
    ...
    parser.add_argument('--config_file', default='/home/taoye/code/DINO-main/config/DINO/DINO_4scale_swin0.py', type=str)
