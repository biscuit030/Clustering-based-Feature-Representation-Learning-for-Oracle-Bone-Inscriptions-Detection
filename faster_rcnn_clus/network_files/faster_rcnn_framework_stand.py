...
from .roi_head_stand import RoIHeads
...
class FasterRCNNBase(nn.Module):
    ...
    def forward(self, images, targets=None):
        ...
        with torch.no_grad():
            ...
            a = images[0].shape[1]
            if images[0].shape[1] > 101:
                images, targets = self.transform(images, targets)
            else:
                images, targets = self.transform_stand(images, targets)
            ...
            pred_features = self.roi_heads(features, proposals, images.image_sizes, targets)
            if pred_features != None:
